...
import { HospitalesClinicasComponent } from './hospitales-clinicas/hospitales-clinicas.component'; // ✅ NUEVA IMPORTACIÓN
...
export const routes: Routes = [
  ...
  { path: 'hospitales-clinicas', component: HospitalesClinicasComponent } // ✅ NUEVA RUTA AÑADIDA
];
